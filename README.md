...
- Run `npm run migrate` in the project folder of this repository (MVP-GreenGrab), in a new terminal window. This will create 3 tables called 'users', 'plans' and 'recipes' in your database.
